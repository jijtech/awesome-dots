...
sudo dnf install tabby-1.0.188-linux-x64.rpm awesome polybar xorg dunst rofi playerctl picom vim krusader acpi zathura firefox lxpolkit materia-gtk-theme lxappearance qt5ct blueman pavucontrol zsh ffmpeg ffmpeg-libs deepin-icon-theme
